...
//-------------------------Recuperation de l'identifiant des IPC ------------------------------------
...
//-------------------------------------------------------------------------------------------------------------------------------
    ...
    //Envoi d'une requete de connexion au serveur(Premiere connections)
    // TO DO
    MESSAGE m;
...
{
    // Envoi d'une requete de logout au serveur+Cancel all voir (serveur)
    // TO DO
...
void WindowClient::on_pushButtonSupprimer_clicked()
{
    ...
    else
    {
        ...
        // Envoi requete CADDIE au serveur pour mise a jour 
...
//----------------------------------Etape1 + 2 pour la Consult---------------------------------------------------
                    if(m.data1 == 0)
                    {
                        ...
                        reponse.type = 1;
                        reponse.expediteur = getpid();
                        reponse.data1 = 1;// l’id de l’article que l’on veut consulter
                        reponse.requete = CONSULT;
...
//-------------------------------------------------------------------------------------
        ...
        case ACHAT : // TO DO (étape 5)
                    ...
                    else w->dialogueErreur("ACHAT", "Stock insuffisant Desole !");
         ...
         case TIME_OUT : // TO DO (étape 6)
                    ...
                    w->dialogueErreur("TIME OUT", "Automatiquement déconnecté pour cause d’inactivité");
